...
X_train = pd.read_csv('/data/home/bt211037/dissertation/preprocessed_data/X_train.tsv',
                      sep='\t', header=0, index_col=0)

y_train = pd.read_csv('/data/home/bt211037/dissertation/preprocessed_data/y_train.tsv',
                      sep='\t', header=0, index_col=0)

X_test = pd.read_csv('/data/home/bt211037/dissertation/preprocessed_data/X_test.tsv',
                      sep='\t', header=0, index_col=0)

y_test = pd.read_csv('/data/home/bt211037/dissertation/preprocessed_data/y_test.tsv',
                      sep='\t', header=0, index_col=0)
...
X_train = feature_encoding(X_train, Onehot=onehot)


# Hyperparameter search
test_hyper = svm_hyperparam(X_train, y_train.values.ravel(), 20, 5)
